  ...
  return (
    ...
    >
      <nav className="relative max-w-[var(--container-max-width)] mx-auto px-4 sm:px-5 md:px-8 h-[70px] md:h-[90px] flex items-center justify-between">
        ...
        >
          <span
            className={`block w-6 h-[2px] bg-[#2D2D2D] rounded-sm transition-all duration-300 ${
      ...
      {/* ===== MOBILE MENU OVERLAY ===== */}
      <div
        className={`fixed inset-0 bg-black/50 z-[140] transition-opacity duration-300 lg:hidden ${
      ...
      <div
        className={`fixed top-0 left-0 w-[300px] sm:w-[340px] h-full bg-[#2D2D2D] z-[150] transition-transform duration-350 ease-in-out lg:hidden overflow-y-auto ${
                ...
                <>
                  ...
                  >
                    ...
                    <svg
                      className={`w-4 h-4 text-white/40 transition-transform duration-200 ${
                        mobileSubmenu === item.menuKey ? "rotate-180" : ""
                      }`}
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 ${
                      mobileSubmenu === item.menuKey ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                    }`}
                  >
                    <div className="pl-4 py-2 flex flex-col gap-1">
                      {getMobileSubItems(item.menuKey ?? "").map((sub) => (
                        <Link
                          ...
                          href={sub.href}
                          onClick={closeMobile}
                          className={`py-2.5 text-[14px] no-underline transition-colors ${
                            (sub as any).isHeading
      ...
      <div
        className={`absolute top-[70px] md:top-[90px] left-0 w-full bg-[#FDF8F4] border-t border-gray-100 overflow-hidden transition-all duration-300 ease-in-out shadow-xl hidden lg:block ${
