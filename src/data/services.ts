...
export const services: Service[] = [
  ...
  // ── 6. CryoSkin Fat Loss ──────────────────────────────────
  {
    ...
    galleryImages: [
      "/cryoskin/image 46.png",
      "/cryoskin/image 46 (1).png",
      "/cryoskin/image 46 (2).png",
      "/cryoskin/image 46 (4).png",
      "/cryoskin/image 46 (5).png",
      "/cryoskin/image 46 (6).png",
      "/cryoskin/image 46 (7).png",
      "/cryoskin/image 46 (8).png",
      "/cryoskin/image 47.png",
      "/cryoskin/image 47 (1).png",
      "/cryoskin/image 47 (2).png",
      "/cryoskin/image 47 (3).png",
      "/cryoskin/image 47 (4).png",
      "/cryoskin/image 47 (5).png",
      "/cryoskin/image 47 (6).png",
      "/cryoskin/image 47 (7).png",
    ],
    faqs: [
  ...
  // ── 7. Pure Plasma ────────────────────────────────────────
  {
    ...
    heroSubtitle:
      "FDA-cleared technology that uses ionized gas to form plasma — delivered directly to the skin's surface.",
    heroImage: "/landing/services/pure-plasma.png",
    heroDetailImage: "/landing/services/pure-plasma-skin-treatments.-details.png",
    intro:
      "Pure Plasma is an FDA-cleared treatment that uses ionized gas to form plasma, which delivers heated plasma directly to the skin's surface without damaging the surrounding tissue. The thermal effect produced by the plasma energy works to stimulate collagen and elastin production in the skin.",
    type: "info-faq",
    highlights: [
      ...
      { icon: "🏥", title: "FDA CLEARED", desc: "Pure Plasma uses FDA-cleared technology ensuring safety and effectiveness for all skin types." },
    ],
    treats: [
    ...
    faqs: [
      { q: "What is Pure Plasma and how does it work?", a: "PURE PLASMA is a NON-INVASIVE, FDA-cleared skin treatment that uses medical-grade Nitrogen gas, which is ionized through a high energy probe tip, to form nitrogen plasma. Plasma is an ionized gas that is formed when electrical energy passes through a gas, in this case nitrogen, at a high temperature. It is composed of positively charged ions and electrons. Plasma has been used in the past to remove tattoos and other skin abnormalities without damaging the surrounding tissue. Unlike lasers, the plasma energy does not destroy tissues." },
